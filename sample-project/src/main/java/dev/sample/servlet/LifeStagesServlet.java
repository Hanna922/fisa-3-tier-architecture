...
public class LifeStagesServlet extends HttpServlet {
    ...
    private static final int    LOCK_TTL        = 10;
    ...
    private LifeStageDao lifeStageDaoReplica;
    private JedisPool jedisPool;

    @Override
    public void init() throws ServletException {
        ApplicationContext ctx = ApplicationContextListener.getBeanContainer(getServletContext());
        lifeStageDaoReplica = ctx.getBean("lifeStageDaoReplica", LifeStageDao.class);
    ...
    private List<Map<String, Object>> getFromCacheOrDb() {
        ...
        try (Jedis jedis = jedisPool.getResource()) {
            ...
            return lifeStageDaoReplica.findAll();
        }
        ...
        try (Jedis jedis = jedisPool.getResource()) {
            ...
            if ("OK".equals(acquired)) {
                ...
                try {
                    List<Map<String, Object>> result = lifeStageDaoReplica.findAll();
